...
--         if not lasersActive and not IS_LOWER_VAULT_ON_COOLDOWN and cityPowerState and #(laserDrawDistancePoint - playerCoords) < 20 then
--             lasersActive = true
--             activateLasers(true)
--         elseif lasersActive and (#(laserDrawDistancePoint - playerCoords) > 20 or not cityPowerState) then
--             lasersActive = false
