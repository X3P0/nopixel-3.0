...
Citizen.CreateThread(function()
  while true do
    ...
    if staffEquipped then
      exports['ragdoll']:SetPlayerHealth(GetEntityHealth(PlayerPedId()) + 5)
...
AddEventHandler("fx:staffused", function(equipped)
    ...
    if equipped then
      exports['ragdoll']:SetPlayerArmor(0)
    end
...
AddEventHandler("fx:spell:heal", function()
    exports['ragdoll']:SetPlayerHealth(GetEntityHealth(PlayerPedId()) + 50)
    TriggerEvent('InteractSound_CL:PlayOnOne','/Spells/FairyEffect', 0.4)
    TextDraw("+50 Health")
    chilled = false
end)
...
AddEventHandler("fx:spell:slow", function()
    ...
    exports['ragdoll']:SetPlayerHealth(GetEntityHealth(ped) - 5)
...
AddEventHandler("fx:spell:shock", function()
    ...
    exports['ragdoll']:SetPlayerHealth(GetEntityHealth(ped) - 33)
end)
