CreateThread(function()
  ...
  exports["np-polyzone"]:AddBoxZone("np-fx:audio:stage", vector3(-1540.23, -274.03, 54.65), 1.2, 1.6, {
    heading=322,
    minZ=53.65,
    maxZ=56.45,
    data = {
  ...
  exports["np-polyzone"]:AddBoxZone("np-fx:audio:stage", vector3(-53.87, -2444.64, 28.82), 8.05, 2.4, {
    heading=325,
    minZ=27.72,
    maxZ=31.32,
    data = {
  ...
  exports["np-polyzone"]:AddBoxZone("np-fx:audio:stage", vector3(1721.07, 2527.79, 46.68), 2, 2, {
    heading=27,
    minZ=45.68,
    maxZ=47.88,
    data = {
  ...
  exports["np-polyzone"]:AddBoxZone("np-fx:audio:stage", vector3(-128.64, -607.63, 40.42), 1.4, 1.4, {
    heading=30,
    minZ=39.22,
    maxZ=41.42,
    data = {
