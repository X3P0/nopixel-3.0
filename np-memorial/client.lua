...
local bluedrawables = '{"1":["masks",-1],"2":["hair",2],"3":["torsos",6],"4":["legs",9],"5":["bags",0],"6":["shoes",1],"7":["neck",0],"8":["undershirts",15],"9":["vest",0],"10":["decals",0],"11":["jackets",86],"0":["face",11]}'
local blueprops = '{"1":["glasses",0],"2":["earrings",-1],"3":["mouth",-1],"4":["lhand",-1],"5":["rhand",-1],"6":["watches",-1],"7":["braclets",-1],"0":["hats",106]}'
...
function equipChain(ped)
    return attachProp(ped, 'cg_chain', 10706, -0.02, 0.02, -0.06, -366.0, 19.0, -163.0, true)
end

function balls(data, hasChain)
