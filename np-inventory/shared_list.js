...
itemList['-2084633992'] = {
  ...
  weapon: true,
  information: 'Only to be used inside the arena.',
};
...
itemList['-1719357158'] = {
  ...
  model: '',
  image: 'np_mk14.png',
  information: 'Government (PD/EMS/DOC) Issued Equipment - Shoots long distance with higher penetration at the costs of non-vital flesh damage.',
  weapon: true,
};
...
itemList['-90637530'] = {
  ...
  weapon: true,
  information: 'Shoots long distance with higher penetration at the costs of non-vital flesh damage.',
};
...
itemList['185608774'] = {
  ...
  craft: [
    ...
    [
      { itemid: 'refinedaluminium', amount: 95 },
      { itemid: 'refinedsteel', amount: 95 },
...
itemList['1627465347'] = {
  fullyDegrades: false,
  decayrate: 2.0,
  displayname: 'Thompson Submachine Gun',
  price: 10,
  craft: [
    [
...
itemList['highcaliberammunition'] = {
  fullyDegrades: true,
  decayrate: 1.0,
  displayname: 'High Caliber Ammunition x10',
  craft: [[
    { itemid: 'aluminium', amount: 1 },
    { itemid: 'plastic', amount: 1 },
    { itemid: 'rubber', amount: 1 },
...
itemList['bobvodka'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Bob\'s Vodka',
  price: 5,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_vodka.png',
  information: 'Straight from Poland land',
};
...
itemList['ikeabag'] = {
  ...
  nonStack: false,
  model: '',
  image: 'np_ikeabag.png',
  information: 'Going to ikea?',
};

itemList['ikeameatballs'] = {
  fullyDegrades: false,
  decayrate: 0.1,
  displayname: 'Koettbullar',
  price: 1,
  craft: [
    [
      { itemid: 'huntingmeat', amount: 1 },
      { itemid: 'foodingredient', amount: 1 },
    ],
    [
      { itemid: 'questionablemeat', amount: 1 },
      { itemid: 'foodingredient', amount: 1 },
    ],
  ],
  weight: 0,
  nonStack: false,
  model: '',
  image: 'np_koettbullar.png',
  information: 'Das dat koettbullar',
};
...
itemList["civradio"] = {
  ...
  model: "",
  image: "np_radio.png",
  information: "Unencrypted - Used to chat with other people on radio channels. Will be seized in crime.",
};
...
itemList['civwatch'] = {
  ...
  information: "Oh well look at there, I know where im going now...",
};
...
itemList['heiststarttoken'] = {
  ...
  model: '',
  image: 'np_receipt.png',
  information: 'Access codes for certain heists. One time use, lasts a single tsunami.',
};
...
itemList['heistloot_tracked'] = {
  fullyDegrades: false,
  illegal: true,
  decayrate: 0.0,
  displayname: 'Tracked Valuable Goods',
  price: 0,
  weight: 1,
  nonStack: false,
  heist_loot: true,
  model: '',
  image: 'np_valuable_goods_chipped.png',
  information: '',
};

itemList['heistloot_usb'] = {
  fullyDegrades: false,
  illegal: true,
  decayrate: 0.0,
...
itemList['heistdrill_grey'] = {
  ...
  blockScrap: true,
  model: '',
  image: 'np_drill_grey.png',
};

itemList['heistdrill_blue'] = {
  fullyDegrades: false,
  decayrate: 2.0,
  displayname: 'Sturdy Drill',
  price: 3500,
  weight: 5,
  nonStack: true,
  blockScrap: true,
  model: '',
  image: 'np_drill_blue.png',
};

itemList['heistdrill_red'] = {
  fullyDegrades: false,
  decayrate: 2.0,
  displayname: 'Hardened Drill',
  price: 3500,
  weight: 5,
  nonStack: true,
  blockScrap: true,
  model: '',
  image: 'np_drill_red.png',
};

itemList['heistelectronickit_grey'] = {
  fullyDegrades: false,
  decayrate: 2.0,
  displayname: 'Basic Electronic Kit',
  price: 10000,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_electronic_kit_grey.png',
};

itemList['heistelectronickit_blue'] = {
  fullyDegrades: false,
  decayrate: 2.0,
  displayname: 'Advanced Electronic Kit',
  price: 20000,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_electronic_kit_blue.png',
};

itemList['heistelectronickit_red'] = {
  fullyDegrades: false,
  decayrate: 2.0,
  displayname: 'Hardened Electronic Kit',
  price: 50000,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_electronic_kit_red.png',
};
...
itemList['heistbox'] = {
  ...
  nonStack: true,
  model: '',
  image: 'np_supplies_paper.png',
  information: 'Its a box',
};

itemList['heistsafecodes'] = {
  fullyDegrades: true,
  decayrate: 0.07,
...
itemList['jammingdevice'] = {
  fullyDegrades: false,
  decayrate: 2.0,
  displayname: 'Jamming Device',
  price: 0,
  weight: 0,
  nonStack: true,
  model: '',
  image: 'np_radio-scanner.png',
  information: 'Marked for police seizure.<br>Keeps the 5G away',
};

itemList['heistkeycard_vault'] = {
  fullyDegrades: false,
  illegal: true,
  decayrate: 0.1,
  displayname: 'Keycard',
...
itemList['heistdecrypter_grey'] = {
  fullyDegrades: false,
  decayrate: 2.0,
  displayname: 'Basic Decrypter',
  price: 10000,
  weight: 1,
  nonStack: false,
  model: '',
...
itemList['heistdecrypter_blue'] = {
  fullyDegrades: false,
  decayrate: 2.0,
  displayname: 'Advanced Decrypter',
  price: 20000,
  weight: 1,
  nonStack: false,
  model: '',
...
itemList['heistdecrypter_red'] = {
  fullyDegrades: false,
  decayrate: 2.0,
  displayname: 'Hardened Decrypter',
  price: 50000,
  weight: 1,
  nonStack: false,
  model: '',
...
itemList['nbcchain'] = {
  ...
  nonStack: true,
  model: '',
  image: 'np_nbc_chain.png',
  information: 'Represent!',
  cgChainCraft: true,
};

itemList['seasidechain'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Seaside Chain',
  craft: [[
    { itemid: 'goldbar', amount: 2 },
    { itemid: 'aluminium', amount: 100 },
    { itemid: 'copper', amount: 100 },
...
itemList['moneycase'] = {
  ...
  information: 'Good for about $50k in large bills.',
  weapon: false,
};
...
itemList['fsupplies_paper'] = {
  fullyDegrades: true,
  decayrate: 0.25,
  displayname: 'Supplies (Papers)',
  price: 13,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_supplies_paper.png',
  information: 'For use in shops and stalls.',
};

itemList['fsupplies_textile'] = {
  fullyDegrades: true,
  decayrate: 0.25,
  displayname: 'Supplies (Textiles)',
  price: 13,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_supplies_textile.png',
  information: 'For use in shops and stalls.',
};

itemList['fsupplies_food'] = {
  fullyDegrades: true,
  decayrate: 0.25,
  displayname: 'Supplies (Foods)',
  price: 13,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_supplies_food.png',
  information: 'For use in shops and stalls.',
};

itemList['fsupplies_import'] = {
  fullyDegrades: true,
  decayrate: 0.25,
  displayname: 'Supplies (Imports)',
  price: 13,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_supplies_import.png',
  information: 'For use in shops and stalls.',
};

itemList['fsupplies_metal'] = {
  fullyDegrades: true,
  decayrate: 0.25,
  displayname: 'Supplies (Metals)',
  price: 13,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_supplies_metal.png',
  information: 'For use in shops and stalls.',
};

itemList['fsupplies_electronic'] = {
  fullyDegrades: true,
  decayrate: 0.25,
  displayname: 'Supplies (Electronics)',
  price: 13,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_supplies_electronic.png',
  information: 'For use in shops and stalls.',
};

itemList['shop_register'] = {
  fullyDegrades: false,
  decayrate: 1.0,
...
itemList['shop_tray'] = {
  fullyDegrades: false,
  decayrate: 1.0,
  displayname: 'Shop Tray',
  price: 250,
  weight: 5,
  nonStack: true,
  model: '',
  image: 'np_shop_tray.png',
  information: 'For use in shops and stalls.',
};

itemList['shop_supply_boxes'] = {
  fullyDegrades: false,
  decayrate: 1.0,
  displayname: 'Shop Supply Boxes',
  price: 500,
  weight: 5,
  nonStack: true,
  model: '',
  image: 'np_shop_supply_boxes.png',
  information: 'For use in shops and stalls.',
};
...
itemList['shop_dish'] = {
  fullyDegrades: false,
  decayrate: 1.0,
  displayname: 'Shop Restaurant Dishes',
  price: 500,
  weight: 5,
  nonStack: true,
  model: '',
...
itemList['shop_manage_board'] = {
  fullyDegrades: false,
  decayrate: 1.0,
  displayname: 'Shop Food Management',
  price: 500,
  weight: 5,
  nonStack: true,
  model: '',
...
itemList['custombagitem'] = {
  ...
  model: '',
  image: 'np_burgershot_bag.png',
  information: 'Contains your order',
};
...
itemList['craftedgemsapphire'] = {
  ...
  nonStack: true,
  model: '',
  image: 'np_gallery_sapphire-ring.png',
  information: '5g',
};
...
itemList['metaldetector4'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'NPX 5000',
  craft: [
    [
      { itemid: 'refinedaluminium', amount: 50 },
      { itemid: 'refinedcopper', amount: 50 },
      { itemid: 'refinedrubber', amount: 50 },
      { itemid: 'refinedplastic', amount: 50 },
    ]
  ],
  price: 25000,
  weight: 20,
...
itemList['mobilecratekeylock'] = {
  ...
  craft: [
    [
      { itemid: 'aluminium', amount: 120 },
      { itemid: 'steel', amount: 120 },
      { itemid: 'plastic', amount: 120 },
      { itemid: 'electronics', amount: 120 },
    ],
    [
      { itemid: 'refinedaluminium', amount: 35 },
      { itemid: 'refinedsteel', amount: 35 },
      { itemid: 'refinedplastic', amount: 35 },
      { itemid: 'electronics', amount: 120 },
    ]
  ],
...
itemList['grandfatherclock'] = {
  ...
  model: '',
  image: 'np_supplies_import.png',
  information: 'Tick tock... (Placeable Object)',
};
...
itemList['storesign'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Store Sign',
  price: 500,
  weight: 25,
  nonStack: true,
  model: '',
  image: 'np_storesign.png',
  information: 'A sign of things to come',
}
...
itemList['seedanalyzer'] = {
  ...
  craft: [[
    { itemid: 'genericelectronicpart', amount: 130 },
  ]],
  price: 4000,
  weight: 0,
  nonStack: true,
  ...
  information: 'This seed analyzer lets you sequence the DNA of a variety of seeds.',
};
...
itemList['drone_lspd'] = {
  ...
  craft: [[
    { itemid: 'genericelectronicpart', amount: 333 },
    { itemid: 'plastic', amount: 500 },
  ]],
  price: 0,
  weight: 11,
...
itemList['phonebomb'] = {
  ...
  information: 'Dial carefully.',
  contraband: false,
};

itemList['phonebombdefused'] = {
  fullyDegrades: false,
  illegal: false,
  decayrate: 0.0,
  displayname: 'Defused Remote Bomb',
  price: 0,
  weight: 7,
  nonStack: true,
  model: '',
...
itemList['rccontroller'] = {
  ...
  decayrate: 0.0,
  craft: [[
    { itemid: 'genericelectronicpart', amount: 50 },
  ]],
...
itemList['gps_tracker'] = {
  fullyDegrades: false,
  illegal: false,
  decayrate: 0.0,
  craft: [[
    { itemid: 'genericelectronicpart', amount: 85 },
  ]],
  ...
  nonStack: true,
  model: '',
  image: 'np_gps_tracker.png',
  information: 'Polo!',
  contraband: false,
};

itemList['gps_locator'] = {
  fullyDegrades: false,
  illegal: false,
  decayrate: 0.0,
  craft: [[
  ...
  displayname: 'GPS Locator',
  price: 0,
  weight: 1,
  nonStack: true,
  model: '',
  image: 'np_gps_locator.png',
  information: 'Marco!',
  contraband: false,
};
...
itemList['rfscanner'] = {
  ...
  decayrate: 2.0,
  craft: [[
    { itemid: 'genericelectronicpart', amount: 175 },
  ]],
  ...
  nonStack: true,
  model: '',
  image: 'np_rf_scanner.png',
  information: '5G Towers are everywhere!',
  contraband: false,
};

itemList['cryptominer'] = {
  fullyDegrades: false,
  illegal: false,
  decayrate: 0.0,
  craft: [[
    { itemid: 'genericelectronicpart', amount: 100 },
  ]],
  displayname: 'NVL 5150 GPU',
  price: 0,
  weight: 1,
  nonStack: true,
  model: '',
  image: 'np_gpu.png',
  information: 'To the moon!',
  contraband: false,
};
...
itemList['simcard'] = {
  ...
  decayrate: 0.0,
  craft: [[
    { itemid: 'genericelectronicpart', amount: 25 },
  ]],
  displayname: 'SIM Replacement Card',
  price: 0,
  weight: 1,
  nonStack: true,
  model: '',
  image: 'np_sim_card.png',
  information: 'Only compatible with the latest BURNER(TM) phones.',
  contraband: false,
};

itemList['movementsensor'] = {
  fullyDegrades: false,
  illegal: false,
  decayrate: 0.0,
  craft: [[
    { itemid: 'genericelectronicpart', amount: 250 },
  ]],
  ...
  model: '',
  image: 'np_sensor.png',
  information: 'Email alerts powered by GOPOSTAL',
  contraband: false,
};
...
itemList['barrel_fuel'] = {
  ...
  oilbarrel: true,
  information: 'Barrel used to store different kinds of oils.',
};
...
itemList['C4_arcade'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Arcade C4',
  price: 100,
  weight: 5,
  nonStack: true,
  model: '',
  image: 'np_c4.png',
  information: 'Fake C4 used in the arcade.',
};
...
itemList['casinopantherstatue'] = {
  ...
  information: "Its all connected. <br><br><i>For being one of the first to complete the Casino Heist.</i>",
  placeableObject: "h4_prop_h4_art_pant_01a",
  placeableInfo: "For being one of the first to complete the Casino Heist.",
};
...
itemList['xqcgrenade'] = {
  ...
  placeableInfo: "1 of 1. For solving the Casino Heist riddle.",
};
...
itemList['rearingbroncostatue'] = {
  ...
  placeableInfo: "1 of 1. For solving one of the 3.0 anniversary riddles.",
};
...
itemList['woodbenchsigned'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Signed Wood Bench',
  price: 350,
  weight: 0,
  nonStack: false,
  model: '',
  image: 'np_props_woodbench.png',
  information: 'Sit on it.  <br><br><i>Authentic Signed Bench Guy Crafted Wood Bench.</i>',
  placeableObject: "np_prop_bench_06",
  placeableInfo: "Authentic Signed Bench Guy Crafted Wood Bench",
};
...
itemList['outbreak_skill_portal'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Zombie Portal',
  price: 350,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_zombie_portal.png',
  information: 'Brains... (Event Skill)',
};
...
itemList['craterepairkit'] = {
  fullyDegrades: true,
  decayrate: 1,
  displayname: 'Container Repair Kit',
  price: 12500,
  craft: [],
  weight: 1,
  nonStack: false,
  craft: [
    ...
    [
      { itemid: 'refinedaluminium', amount: 120 },
      { itemid: 'refinedsteel', amount: 120 },
    ]
  ],
  model: '',
  image: 'np_crate_repair_kit.png',
  information: 'Used to repair a container to give it a longer lifespan. The bigger the crate the more this item wears out.',
}

itemList['driftanglekit'] = {
  fullyDegrades: true,
  decayrate: 1,
  displayname: 'Drift Angle Kit',
  price: 100,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_drift_angle_kit.png',
  craft: [[
    { itemid: 'hqparts', amount: 25 },
    { itemid: 'refinedaluminium', amount: 1000 },
  ]],
};

itemList['driftcoilovers'] = {
  fullyDegrades: true,
  decayrate: 1,
  displayname: 'Drift Adjustable Coilovers',
  price: 100,
  weight: 1,
  nonStack: false,
  model: '',
...
itemList['driftdiff'] = {
  fullyDegrades: true,
  decayrate: 1,
  displayname: 'Drift Differential',
  price: 100,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_drift_differential.png',
  craft: [[
    { itemid: 'hqparts', amount: 25 },
    { itemid: 'refinedaluminium', amount: 1000 },
  ]],
...
itemList['drifttires'] = {
  fullyDegrades: true,
  decayrate: 1,
  displayname: 'Drift Tires',
  price: 100,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_drift_tires.png',
  craft: [[
    { itemid: 'rubber', amount: 500 },
  ]],
};

itemList['drifthandbrake'] = {
  fullyDegrades: true,
  decayrate: 1,
  displayname: 'Drift Hydraulic Handbrake',
  price: 100,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_drift_hydraulic_handbrake.png',
  craft: [[
    { itemid: 'hqparts', amount: 25 },
    { itemid: 'refinedaluminium', amount: 1000 },
  ]],
...
itemList['towrope'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Tow Rope',
  price: 10,
  weight: 10,
  nonStack: false,
  model: '',
  image: 'np_tow_rope.png',
  information: 'Could be attached to a car, and maybe something else?',
  craft: [],
};
...
itemList['jewelry_part'] = {
  fullyDegrades: false,
  decayrate: 2,
  displayname: 'Jewelry Part',
  craft: [[]],
  price: 0,
  weight: 0,
  nonStack: false,
  model: '',
  image: 'np_jewelry_part.png',
  information: "Will fetch a fair price at the right place",
};

itemList['jewelry_ring'] = {
  _name: 'jewelry_ring',
  fullyDegrades: false,
  decayrate: 0.25,
  displayname: 'Ring',
...
itemList['jewelry_necklace'] = {
  _name: 'jewelry_necklace',
  fullyDegrades: false,
  decayrate: 0.25,
...
itemList['wingsuit'] = {
  ...
  craft: [
    [
      { itemid: 'aluminium', amount: 320 },
      { itemid: 'copper', amount: 320 },
      { itemid: 'steel', amount: 320 },
    ],
    [
      { itemid: 'refinedaluminium', amount: Math.ceil((320 / 3) * 0.9) },
      { itemid: 'refinedcopper', amount: Math.ceil((320 / 3) * 0.9) },
      { itemid: 'refinedsteel', amount: Math.ceil((320 / 3) * 0.9) },
    ]
  ],
};
...
itemList['atmblackbox'] = {
  ...
  nonStack: false,
  model: '',
  image: 'np_atm_blackbox.png',
  information: 'How did you get this out of the wall?',
};
...
itemList['karambitcase'] = {
  fullyDegrades: false,
  decayrate: 0,
  displayname: 'Karambit Case',
  price: 100,
  weight: 5,
  nonStack: true,
  craft: [[
    { itemid: 'bclubtoken', amount: 8 },
  ]],
  model: '',
  image: 'np_karambit_case.png',
  contraband: false,
};
...
itemList['bagelcake'] = {
  fullyDegrades: true,
  decayrate: 1,
  displayname: 'Bagel Cake',
  information: 'Special cake made by Peach Chee to celebrate Toretti’s Birthday. This cake is intended to be eaten by Toretti’s many girlfriends.',
  price: 100,
  weight: 1,
  nonStack: true,
  model: '',
  image: 'np_bagelcake.png',
  craft: [],
};

itemList['srubbingcloth'] = {
  fullyDegrades: true,
  decayrate: 0.001388,
  ...
  nonStack: true,
  model: '',
  image: 'np_srubbingcloth.png',
  craft: [],
  information: 'These seem to dry up fast...',
};

itemList['gangflag'] = {
  fullyDegrades: true,
  decayrate: 1,
  displayname: 'Gang Flag',
  price: 100,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_gangflag.png',
  information: 'You know what to do with this...',
  craft: []
};
...
itemList['progressionite'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Progressionite',
  craft: [],
  price: 10,
  weight: 1,
  nonStack: true,
  model: '',
  image: 'np_silver-coin.png',
  information: 'NEVER SPAWN THIS',
};

const rampCraftCost = 75;
let rampMulti = 1;
itemList['deploy_ramp1'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Ramp (Baby)',
  price: 350,
  weight: 11,
  nonStack: false,
  model: '',
  heist_loot: true,
  image: 'np_ramp.png',
  information: "Erodes after 3 hours.",
  craft: [
    [
      { itemid: 'aluminium', amount: rampCraftCost * rampMulti },
      { itemid: 'copper', amount: rampCraftCost * rampMulti },
      { itemid: 'steel', amount: rampCraftCost * rampMulti },
    ],
    [
      { itemid: 'refinedaluminium', amount: Math.ceil(((rampCraftCost * rampMulti) / 3) * 0.9) },
      { itemid: 'refinedcopper', amount: Math.ceil(((rampCraftCost * rampMulti) / 3) * 0.9) },
      { itemid: 'refinedsteel', amount: Math.ceil(((rampCraftCost * rampMulti) / 3) * 0.9) },
    ],
  ],
  deployableObject: "stt_prop_ramp_jump_xs",
  deployableExpires: 60 * 60 * 3,
};
rampMulti += 1;
itemList['deploy_ramp2'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Ramp (Child)',
  price: 350,
  weight: 11,
  nonStack: false,
  model: '',
  ...
  deployableObject: "stt_prop_ramp_jump_s",
  deployableExpires: 60 * 60 * 3,
};
rampMulti += 1;
itemList['deploy_ramp3'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Ramp (Teenager)',
  price: 350,
  weight: 11,
  nonStack: false,
  model: '',
  ...
  deployableObject: "stt_prop_ramp_jump_m",
  deployableExpires: 60 * 60 * 3,
};
rampMulti += 1;
itemList['deploy_ramp4'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Ramp (Adult)',
  price: 350,
  weight: 11,
  nonStack: false,
  model: '',
  ...
  deployableObject: "stt_prop_ramp_jump_l",
  deployableExpires: 60 * 60 * 3,
};
rampMulti += 1;
itemList['deploy_ramp5'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Ramp (Giant)',
  price: 350,
  weight: 11,
  nonStack: false,
  model: '',
  ...
  deployableObject: "stt_prop_ramp_jump_xl",
  deployableExpires: 60 * 60 * 3,
};
rampMulti += 1;
itemList['deploy_ramp6'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Ramp (Monster)',
  price: 350,
  weight: 11,
  nonStack: false,
  model: '',
  ...
  information: "Erodes after 3 hours.",
  deployableObject: "stt_prop_ramp_jump_xxl",
  deployableExpires: 60 * 60 * 3,
};

itemList['deploy_ramp_loop'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Ramp (Loop)',
  price: 350,
  weight: 11,
  nonStack: false,
  model: '',
  ...
  information: "Erodes after 3 hours.",
  deployableObject: "stt_prop_ramp_adj_loop",
  deployableExpires: 60 * 60 * 3,
};
...
itemList['deploy_mic'] = {
  ...
  model: '',
  heist_loot: true,
  image: 'np_microphone_stand.png',
  information: "3 Day Rental",
  deployableObject: "v_club_roc_micstd",
  deployableExpires: 60 * 60 * 24 * 3,
};

itemList['deploy_stage0'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Stage (Extra Small)',
  price: 4000,
  weight: 11,
  nonStack: false,
  model: '',
  heist_loot: true,
  image: 'np_deploy_stage.png',
  information: "3 Day Rental",
  deployableObject: "np_stage_music_xs",
  deployableExpires: 60 * 60 * 24 * 3,
};

itemList['deploy_stage1'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Stage (Small)',
  price: 8000,
  weight: 11,
  nonStack: false,
  model: '',
  ...
  image: 'np_deploy_stage.png',
  information: "3 Day Rental",
  deployableObject: "np_stage_music_s",
  deployableExpires: 60 * 60 * 24 * 3,
};

itemList['deploy_stage2'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Stage (Medium)',
  price: 16000,
  weight: 11,
  nonStack: false,
  model: '',
  ...
  image: 'np_deploy_stage.png',
  information: "3 Day Rental",
  deployableObject: "np_stage_music_m",
  deployableExpires: 60 * 60 * 24 * 3,
};

itemList['deploy_stage3'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Stage (Large)',
  price: 32000,
  weight: 11,
  nonStack: false,
  model: '',
  ...
  image: 'np_deploy_stage.png',
  information: "3 Day Rental",
  deployableObject: "np_stage_music_l",
  deployableExpires: 60 * 60 * 24 * 3,
};

itemList['fireworks_starter'] = {
  fullyDegrades: true,
  decayrate: 0.2,
  displayname: 'Fireworks Launcher',
  price: 2500,
  weight: 11,
  nonStack: false,
  model: '',
  heist_loot: true,
  image: 'np_fireworks.png',
  information: "",
};

itemList['deploy_pride_arch'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  displayname: 'Pride Arch',
  price: 1000,
  weight: 11,
  nonStack: false,
  model: '',
  heist_loot: true,
  image: 'np_pride_flag.png',
  information: "",
  deployableObject: "pride_arcoiro",
};

itemList['deploy_pride_bal'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  displayname: 'Pride Balloons',
  price: 1000,
  weight: 11,
  nonStack: false,
  model: '',
  ...
  image: 'np_pride_flag.png',
  information: "",
  deployableObject: "pride_balao",
};

itemList['deploy_pride_word_statue'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  displayname: 'Pride Word Statue',
  price: 1000,
  weight: 11,
  nonStack: false,
  model: '',
  ...
  image: 'np_pride_flag.png',
  information: "",
  deployableObject: "pride_pride",
};

itemList['deploy_pride_fist_statue'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  displayname: 'Pride Fist Statue',
  price: 1000,
  weight: 11,
  nonStack: false,
  model: '',
  ...
  image: 'np_pride_flag.png',
  information: "",
  deployableObject: "pride_pride_mao",
};

itemList['deploy_pride_tents'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  displayname: 'Pride Tent',
  price: 1000,
  weight: 11,
  nonStack: false,
  model: '',
  ...
  image: 'np_pride_flag.png',
  information: "",
  deployableObject: "pride_tenda",
};

itemList['deploy_pride_lgbt_statue'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  displayname: 'Pride LGBTQIA+ Statue',
  price: 1000,
  weight: 11,
  nonStack: false,
  model: '',
  ...
  image: 'np_pride_flag.png',
  information: "",
  deployableObject: "pride_lgbtqia+",
};

itemList['deploy_pride_beyou_statue'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  displayname: 'Pride Be You Statue',
  price: 1000,
  weight: 11,
  nonStack: false,
  model: '',
  ...
  image: 'np_pride_flag.png',
  information: "",
  deployableObject: "pride_be_you",
};

itemList['deploy_pride_boca_statue'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  displayname: 'Pride Boca Statue',
  price: 1000,
  weight: 11,
  nonStack: false,
  model: '',
  ...
  image: 'np_pride_flag.png',
  information: "",
  deployableObject: "pride_boca",
};

itemList['deploy_pride_leque_statue'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  displayname: 'Pride Leque Statue',
  price: 1000,
  weight: 11,
  nonStack: false,
  model: '',
...
itemList['oilpumpclutch'] = {
  fullyDegrades: true,
  decayrate: 1,
  displayname: 'Oil Pump Clutch',
  price: 100,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_pumpclutch.png',
  craft: [
    [
...
itemList['oilpumpbelt'] = {
  fullyDegrades: true,
  decayrate: 1,
  displayname: 'Oil Pump Belt',
  price: 100,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_pumpbelt.png',
  craft: [
    [{ itemid: 'plastic', amount: 13 }],
  ],
  pumpPart: true,
};
...
itemList['oilpumprod'] = {
  fullyDegrades: true,
  decayrate: 1,
  displayname: 'Oil Pump Polished Rod',
  price: 100,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_polishedrod.png',
  craft: [
    [
      { itemid: 'steel', amount: 6 },
...
itemList['npolaroid_camera'] = {
  fullyDegrades: true,
  decayrate: 1,
  displayname: 'NPolaroid Camera',
  information: 'Snap a picture!',
  price: 22500,
  weight: 10.0,
  nonStack: true,
  model: '',
  image: 'np_npolaroid.png',
  craft: [
    [
      { itemid: 'glass', amount: 450 },
      { itemid: 'plastic', amount: 450 },
      { itemid: 'aluminium', amount: 225 }
    ],
    [
      { itemid: 'refinedglass', amount: 150 },
      { itemid: 'refinedplastic', amount: 150 },
      { itemid: 'refinedaluminium', amount: 75 }
    ]
  ],
};

itemList['npolaroid_paper'] = {
  fullyDegrades: true,
  decayrate: 1,
  displayname: 'NPolaroid Film',
  information: 'Required to snap a picture!',
  price: 175,
  weight: 1.0,
  nonStack: false,
  model: '',
  image: 'np_npolaroid_paper.png',
  craft: [
    [
      { itemid: 'plastic', amount: 12 }
    ],
    [
      { itemid: 'refinedplastic', amount: 4 }
    ]
  ],
};

itemList['npolaroid_photo'] = {
  fullyDegrades: true,
  decayrate: 1,
  displayname: 'NPolaroid Photo',
  price: 100,
  weight: 1.0,
  nonStack: false,
  model: '',
  image: 'np_npolaroid_photo.png',
  craft: [],
  insertTo: ['npolaroid_photobook'],
};

itemList['npolaroid_photobook'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'NPolaroid Photobook',
  price: 32500,
  weight: 5.0,
  nonStack: false,
  model: '',
  image: 'np_npolaroid_photobook.png',
  craft: [
    [
      { itemid: 'plastic', amount: 1800 },
      { itemid: 'aluminium', amount: 75 }
    ],
    [
      { itemid: 'refinedplastic', amount: 600 },
      { itemid: 'refinedaluminium', amount: 25 }
    ]
  ],
};

itemList['npolaroid_battery'] = {
  fullyDegrades: true,
  decayrate: 0.1,
  displayname: 'NPolaroid Battery Pack',
  price: 9000,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_npolaroid_battery.png',
  craft: [
    [
      { itemid: 'aluminium', amount: 375 }
    ],
    [
      { itemid: 'refinedaluminium', amount: 125 }
    ]
  ],
  insertTo: ['npolaroid_camera'],
};
...
itemList['barrelpile'] = {
  ...
  illegal: false,
  decayrate: 0.0,
  displayname: 'Barrel Pile',
  price: 340,
  weight: 5,
  nonStack: true,
  model: '',
  image: 'barrelpile.png',
  information: '',
  whitelist: [
    "oilbarrel"
  ],
...
itemList['poppyseeds'] = {
  ...
  nonStack: false,
  model: '',
  image: 'np_poppyseeds.png',
  information: 'Marked for police seizure',
  contraband: true,
};

itemList['poppy_tears'] = {
  fullyDegrades: true,
  decayrate: 0.5,
  ...
  nonStack: true,
  model: '',
  image: 'np_poppytears.png',
  information: 'Marked for police seizure',
  contraband: true,
};

itemList['heroin_brick'] = {
  fullyDegrades: true,
  decayrate: 2.0,
  displayname: 'Heroin Brick',
  price: 1,
  weight: 10,
  craft: [[
    { itemid: 'poppy_tears', amount: 5 },
  ]],
  nonStack: true,
  model: '',
  image: 'np_heroinbrick.png',
  information: '',
  contraband: true,
};

itemList['heroin_syringe'] = {
  fullyDegrades: true,
  decayrate: 2.0,
  displayname: 'Heroin Syringe',
  price: 1,
  weight: 1,
  nonStack: true,
  model: '',
  image: 'np_heroin_syringe.png',
  information: '',
  contraband: true,
};

itemList['citric_acid_powder'] = {
  fullyDegrades: true,
  decayrate: 0.5,
  displayname: 'Citric Acid Powder',
  price: 1,
  weight: 10,
  nonStack: false,
  model: '',
  image: 'np_citricacid.png',
  information: '',
  contraband: true,
};

itemList['heroin_syringe_empty'] = {
  fullyDegrades: true,
  decayrate: 2.0,
...
itemList['arcadeticket'] = {
  fullyDegrades: true,
  decayrate: 0.5,
  displayname: 'Arcade ticket',
  price: 1,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_arcadeticket.png',
  information: '',
};

itemList['microchipimplant'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Microchip Implant',
  price: 5000,
  weight: 0,
  nonStack: true,
  model: '',
  image: 'np_microchip-implant.png',
  information: 'Implant for humans',
};

itemList['microchipcontroller'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Microchip Controller',
  price: 100000,
  weight: 0,
  nonStack: true,
  model: '',
  image: 'np_microchip-controller.png',
  information: 'Tablet-looking device, nothing out of the ordinary.',
};
...
itemList['vineyardspray'] = {
  ...
  nonStack: true,
  model: '',
  image: 'np_vineyard_spray.png',
  information: 'Spray over the vineyard to get grapes ready for harvest.',
};

itemList['vineyardgrapes'] = {
  _name: 'vineyardgrapes',
  fullyDegrades: true,
  decayrate: 0.25,
  displayname: 'Harvested Grapes',
  price: 100000,
  weight: 0,
  nonStack: false,
  model: '',
  image: 'np_grapes.png',
  information: "Throw them in a barrel, lets get this party started.",
};
...
itemList['vineyardbarrelheadopener'] = {
  fullyDegrades: false,
  decayrate: 1.0,
  displayname: 'Barrel Head Opener',
  price: 1000,
  weight: 1,
  nonStack: true,
  model: '',
  image: 'np_crowbar.png',
  information: "Allow breaking barrel seals.",
};

itemList['vineyardwinebox'] = {
  _name: 'vineyardwinebox',
  fullyDegrades: true,
  decayrate: 1.0,
  displayname: 'Wine Box',
  price: 2500,
  weight: 12,
  nonStack: true,
  model: '',
  image: 'np_honest_wine_box.png',
  information: "Fits 6 bottles of your finest.",
};

itemList['vineyardwinebottleempty'] = {
  fullyDegrades: true,
  decayrate: 2.0,
  displayname: 'Empty Bottles for Wine',
  price: 2000,
  weight: 12,
  nonStack: true,
  model: '',
  image: 'np_winebottles_empty.png',
  information: "Fill them up.",
};

itemList['vineyardwinebottle'] = {
  _name: 'vineyardwinebottle',
  fullyDegrades: true,
  decayrate: 2.0,
  ...
  model: '',
  image: 'np_honest_wine.png',
  information: "Made to your liking!",
};

itemList['miscscrap'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Miscellaneous Scrap',
  price: 0,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_miscscrap.png',
  information: 'Random pieces of scrap.',
};

itemList['stolenvehiclerim'] = {
  fullyDegrades: true,
  decayrate: 0.5,
  displayname: 'Vehicle Rim',
  price: 0,
  weight: 10,
  nonStack: false,
  model: '',
  image: 'np_stolen_vehicle_rim.png',
  information: 'Looks like a vehicle rim?',
  craft: [[
    { itemid: 'scrapmetal', amount: 3 },
  ]]
};

itemList['screwdriver'] = {
  fullyDegrades: true,
  decayrate: 0.5,
  ...
  nonStack: false,
  model: '',
  image: 'np_screwdriver.png',
  information: '',
};

itemList['arcadetoken'] = {
  fullyDegrades: true,
  decayrate: 0.5,
  ...
  nonStack: false,
  model: '',
  image: 'np_arcadetoken.png',
  information: 'Used to insert into Demons Den Arcade machines',
};

itemList['seaside_beachpass'] = {
  fullyDegrades: true,
  decayrate: 0.5,
  displayname: 'Seaside Beach Pass',
  price: 0,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_seaside_beachpass.png',
  information: 'Better have one if you want to go to the seaside beach',
};

itemList['cispringboots'] = {
  fullyDegrades: false,
  decayrate: 0.0,
...
itemList['phonebooth'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Red Phone Booth',
  price: 9999,
  craft: [[
    { itemid: 'scrapmetal', amount: 10000 },
  ]],
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_phonebooth.png',
  information: 'Now you can call Stuarts',
};
...
itemList['titanium'] = {
  ...
  nonStack: false,
  model: '',
  image: 'np_titanium.png',
  information: 'About 2 tonnes of it...',
};

itemList['cabinetpick'] = {
  fullyDegrades: true,
  decayrate: 0.1,
  displayname: 'Cabinet Lockpick',
  price: 0,
  weight: 1,
  nonStack: false,
  craft: [
    ...
    [
      { itemid: 'refinedaluminium', amount: 6 },
      { itemid: 'refinedplastic', amount: 6 },
      { itemid: 'refinedrubber', amount: 6 },
    ]
  ],
  model: '',
  image: 'np_lockpick-set.png',
  information: 'Looks like this was made to break into some cabinets..',
};

itemList['gunpaint'] = {
  fullyDegrades: true,
  decayrate: 0.1,
  displayname: 'Gun Paint',
  price: 0,
  weight: 1,
  nonStack: false,
  craft: [
    ...
    [
      { itemid: 'refinedsteel', amount: 45 },
      { itemid: 'refinedplastic', amount: 45 },
    ]
  ],
  model: '',
  image: 'np_gunpaint.png',
  information: 'Looks like you can color a gun with this.',
  insertTo: ['-1074790547', '185608774'],
};

itemList['mobilebillboard1'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Mobile Billboard 1',
  price: 0,
  weight: 50,
  nonStack: false,
  model: '',
  image: 'np_billboard.png',
  information: 'A billboard mate',
};

itemList['mobilebillboard2'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Mobile Billboard 2',
  price: 0,
  weight: 50,
  nonStack: false,
  model: '',
...
itemList['mobilebillboard3'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Mobile Billboard 3',
  price: 0,
  weight: 50,
  nonStack: false,
  model: '',
...
itemList['weedbong'] = {
  ...
  decayrate: 0.5,
  isStolen: false,
  displayname: 'Weed Bong',
  price: 0,
  weight: 5,
  nonStack: true,
  craft: [[
    { itemid: 'glass', amount: 100 },
  ]],
  model: '',
  image: 'np_bong.png',
  information: 'Hmm this seems interesting...',
...
itemList['goldpantray'] = {
  fullyDegrades: true,
  decayrate: 0.25,
  displayname: 'Pan for Gold',
  price: 250,
  weight: 1,
  nonStack: true,
  model: '',
  image: 'np_shop_tray.png',
  information: 'Shallow streams of water may have gold!',
};

itemList['lsccard'] = {
  fullyDegrades: false,
  decayrate: 0.5,
  displayname: 'LSC Insurance Card',
  price: 0,
  weight: 0,
  nonStack: true,
  model: '',
  image: 'np_lsc-card.png',
  information: 'Los Santos Care personal insurance information.',
};

itemList['ci_missile_launcher'] = {
  fullyDegrades: false,
  decayrate: 0,
  displayname: 'CI Missile Armer',
  price: 0,
  weight: 0,
  nonStack: true,
  model: '',
  image: 'np_ci_missile.png',
  information: 'Cerberus Industries - We are not evil.',
};

itemList['abstract_guitar'] = {
  fullyDegrades: true,
  decayrate: 1.5,
  displayname: 'Abstract Electric Guitar',
  craft: [
    [
      { itemid: 'steel', amount: 240 },
      { itemid: 'aluminium', amount: 240 },
      { itemid: 'wood', amount: 240 },
      { itemid: 'genericelectronicpart', amount: 20 },
      { itemid: 'stolenBrokenGoods', amount: 1 },
      { itemid: 'GuitarStrings', amount: 6 },
      { itemid: 'beeswax', amount: 5 },
    ],
    [
      { itemid: 'refinedsteel', amount: 60 },
      { itemid: 'refinedaluminium', amount: 60 },
      { itemid: 'refinedwood', amount: 60 },
      { itemid: 'genericelectronicpart', amount: 20 },
      { itemid: 'stolenBrokenGoods', amount: 1 },
      { itemid: 'GuitarStrings', amount: 6 },
      { itemid: 'beeswax', amount: 5 },
  ...
  nonStack: true,
  model: '',
  image: 'np_guitar_abstract.png',
  information: 'Jammin',
};

itemList['purple_guitar'] = {
  fullyDegrades: true,
  decayrate: 1.5,
  displayname: 'Purple Electric Guitar',
  craft: [
    [
      { itemid: 'steel', amount: 240 },
      { itemid: 'aluminium', amount: 240 },
  ...
  nonStack: true,
  model: '',
  image: 'np_guitar_purple.png',
  information: 'Jammin',
};

itemList['black_guitar'] = {
  fullyDegrades: true,
  decayrate: 1.5,
  displayname: 'Black Electric Guitar',
  craft: [
    [
      { itemid: 'steel', amount: 180 },
      { itemid: 'scrapmetal', amount: 180 },
      { itemid: 'aluminium', amount: 180 },
      { itemid: 'copper', amount: 180 },
      { itemid: 'genericelectronicpart', amount: 20 },
      { itemid: 'lockpick', amount: 5 },
      { itemid: '-538741184', amount: 1 },
      { itemid: 'GuitarStrings', amount: 6 },
      { itemid: 'carpolish_high', amount: 5 },
    ],
    [
      { itemid: 'refinedsteel', amount: 45 },
      { itemid: 'refinedscrap', amount: 45 },
      { itemid: 'refinedaluminium', amount: 45 },
      { itemid: 'refinedcopper', amount: 45 },
      { itemid: 'genericelectronicpart', amount: 20 },
      { itemid: 'lockpick', amount: 5 },
      { itemid: '-538741184', amount: 1 },
      { itemid: 'GuitarStrings', amount: 6 },
  ...
  nonStack: true,
  model: '',
  image: 'np_guitar_black.png',
  information: 'Metal AF',
};

itemList['puppers_guitar'] = {
  fullyDegrades: true,
  decayrate: 1.5,
  displayname: 'Puppers Electric Guitar',
  craft: [
    [
      { itemid: 'steel', amount: 180 },
      { itemid: 'scrapmetal', amount: 180 },
...
itemList['green_guitar'] = {
  fullyDegrades: true,
  decayrate: 1.5,
  displayname: 'Green Electric Guitar',
  craft: [
    [
      { itemid: 'steel', amount: 240 },
      { itemid: 'aluminium', amount: 240 },
  ...
  nonStack: true,
  model: '',
  image: 'np_guitar_green.png',
  information: 'Jammin',
};

itemList['white_guitar'] = {
  fullyDegrades: true,
  decayrate: 1.5,
  displayname: 'White Electric Guitar',
  craft: [
    [
      { itemid: 'steel', amount: 240 },
      { itemid: 'aluminium', amount: 240 },
  ...
  nonStack: true,
  model: '',
  image: 'np_guitar_white.png',
  information: 'Jammin',
};

itemList['pink_guitar'] = {
  fullyDegrades: true,
  decayrate: 1.5,
  displayname: 'Pink Electric Guitar',
  craft: [
    [
      { itemid: 'steel', amount: 240 },
      { itemid: 'aluminium', amount: 240 },
  ...
  nonStack: true,
  model: '',
  image: 'np_guitar_pink.png',
  information: 'Jammin',
};

itemList['dark_red_guitar'] = {
  fullyDegrades: true,
  decayrate: 1.5,
  displayname: 'Dark Red Electric Guitar',
  craft: [
    [
      { itemid: 'steel', amount: 240 },
      { itemid: 'aluminium', amount: 240 },
  ...
  nonStack: true,
  model: '',
  image: 'np_guitar_dark_red.png',
  information: 'Jammin',
};

itemList['yellow_guitar'] = {
  fullyDegrades: true,
  decayrate: 1.5,
  displayname: 'Yellow Electric Guitar',
  craft: [
    [
      { itemid: 'steel', amount: 240 },
      { itemid: 'aluminium', amount: 240 },
  ...
  nonStack: true,
  model: '',
  image: 'np_guitar_yellow.png',
  information: 'Jammin',
};

itemList['anime_guitar'] = {
  fullyDegrades: true,
  decayrate: 1.5,
  displayname: 'Anime Electric Guitar',
  craft: [
    [
      { itemid: 'steel', amount: 240 },
      { itemid: 'aluminium', amount: 240 },
  ...
  nonStack: true,
  model: '',
  image: 'np_guitar_anime.png',
  information: 'Jammin',
};

itemList['blue_guitar'] = {
  fullyDegrades: true,
  decayrate: 1.5,
  ...
  nonStack: true,
  model: '',
  image: 'np_guitar_blue.png',
  information: 'Jammin',
};

itemList['acoustic_guitar'] = {
  fullyDegrades: true,
  decayrate: 1.5,
  displayname: 'Acoustic Guitar',
  craft: [
    [
      { itemid: 'plastic', amount: 240 },
      { itemid: 'wood', amount: 480 },
      { itemid: 'rubber', amount: 240 },
      { itemid: 'stolenBrokenGoods', amount: 1 },
      { itemid: 'GuitarStrings', amount: 6 },
      { itemid: 'beeswax', amount: 5 },
    ],
    [
      { itemid: 'refinedplastic', amount: 60 },
      { itemid: 'refinedwood', amount: 120 },
      { itemid: 'refinedrubber', amount: 60 },
      { itemid: 'stolenBrokenGoods', amount: 1 },
      { itemid: 'GuitarStrings', amount: 6 },
      { itemid: 'beeswax', amount: 5 },
  ...
  nonStack: true,
  model: '',
  image: 'np_guitar_acoustic.png',
  information: 'Jammin',
};

itemList['black_acoustic_guitar'] = {
  fullyDegrades: true,
  decayrate: 1.5,
  displayname: 'Black Acoustic Guitar',
  craft: [
    [
      { itemid: 'plastic', amount: 240 },
      { itemid: 'wood', amount: 480 },
  ...
  nonStack: true,
  model: '',
  image: 'np_guitar_acoustic_black.png',
  information: 'Jammin',
};

itemList['roots_acoustic_guitar'] = {
  fullyDegrades: true,
  decayrate: 3.0,
  displayname: 'Roots Acoustic Guitar',
  price: 3000,
  weight: 11,
  nonStack: true,
  model: '',
  image: 'np_guitar_acoustic.png',
  information: 'Rootin for Peren',
};

itemList['cross_acoustic_guitar'] = {
  fullyDegrades: true,
  decayrate: 3.0,
  displayname: 'Cross Acoustic Guitar',
  price: 3000,
  weight: 11,
  nonStack: true,
  model: '',
  image: 'np_guitar_acoustic_cross.png',
  information: '+ + + + + +',
};

itemList['washed_acoustic_guitar'] = {
  fullyDegrades: true,
  decayrate: 1.5,
  displayname: 'Washed Acoustic Guitar',
  craft: [
    [
      { itemid: 'plastic', amount: 240 },
      { itemid: 'wood', amount: 480 },
  ...
  nonStack: true,
  model: '',
  image: 'np_guitar_acoustic_washed.png',
  information: 'Jammin',
};

itemList['hubcaps_guitar'] = {
  fullyDegrades: true,
  decayrate: 3.0,
  displayname: 'Hubcaps Guitar',
  craft: [[
    { itemid: 'steel', amount: 240 },
    { itemid: 'plastic', amount: 240 },
    { itemid: 'wood', amount: 240 },
    { itemid: 'rubber', amount: 240 },
    { itemid: 'stolenvehiclerim', amount: 1 },
    { itemid: 'GuitarStrings', amount: 6 },
    { itemid: 'carpolish_high', amount: 5 },
  ]],
  price: 3000,
  ...
  model: '',
  image: 'np_guitar_dark_red.png',
  information: 'Hubcaps Love Fist Guitar',
};
...
itemList['GuitarCase'] = {
  ...
  nonStack: true,
  model: '',
  image: 'np_guitar_case.png',
  information: 'Carry around a guitar case.',
};

itemList['GuitarStrings'] = {
  fullyDegrades: true,
  decayrate: 2.5,
  ...
  nonStack: true,
  model: '',
  image: 'np_guitar_strings.png',
  insertTo: [
    "green_guitar", "white_guitar", "pink_guitar", "dark_red_guitar", "yellow_guitar", "blue_guitar", "anime_guitar", "puppers_guitar", "black_guitar", "abstract_guitar", "purple_guitar", "acoustic_guitar", "black_acoustic_guitar", "washed_acoustic_guitar",
  ],
  information: 'Bring some life back to your guitar with new strings.',
};

itemList['deploy_dj_stand'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'DJ Stand',
  price: 2000,
  weight: 11,
  nonStack: false,
  model: '',
  heist_loot: true,
  image: 'np_dj_stand.png',
  information: "8 Hour Rental - For Stages",
  deployableObject: "ba_prop_battle_dj_stand",
  deployableExpires: 60 * 60 * 8,
};

itemList['deploy_dj_desk'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'DJ Desk',
  price: 3000,
  ...
  model: '',
  heist_loot: true,
  image: 'np_dj_desk.png',
  information: "8 Hour Rental - For Stages",
  deployableObject: "sf_prop_sf_dj_desk_01a_np",
  deployableExpires: 60 * 60 * 8,
};

itemList['deploy_drum_stool'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Drum Stool',
  price: 500,
  weight: 11,
  nonStack: false,
  model: '',
  heist_loot: true,
  image: 'np_drum_stool.png',
  information: "8 Hour Rental - For Stages",
  deployableObject: "sf_prop_sf_chair_stool_08a_np",
  deployableExpires: 60 * 60 * 8,
};

itemList['deploy_drum_set'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  ...
  model: '',
  heist_loot: true,
  image: 'np_drum_set.png',
  information: "8 Hour Rental - For Stages",
  deployableObject: "sf_prop_sf_drum_kit_01a_np",
  deployableExpires: 60 * 60 * 8,
};

itemList['deploy_drum_conga'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Conga Drums',
  price: 1000,
  weight: 11,
  nonStack: false,
  model: '',
  heist_loot: true,
  image: 'np_drum_conga.png',
  information: "8 Hour Rental - For Stages",
  deployableObject: "sf_prop_sf_cga_drums_01a_np",
  deployableExpires: 60 * 60 * 8,
};

itemList['deploy_piano_bench'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Piano Bench',
  price: 500,
  weight: 11,
  nonStack: false,
  model: '',
  heist_loot: true,
  image: 'np_piano_bench.png',
  information: "8 Hour Rental - For Stages",
  deployableObject: "sf_prop_sf_bench_piano_01a_np",
  deployableExpires: 60 * 60 * 8,
};

itemList['deploy_piano'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Piano',
  price: 3000,
  ...
  image: 'np_piano.png',
  information: "8 Hour Rental - For Stages",
  deployableObject: "sf_prop_sf_piano_01a_np",
  deployableExpires: 60 * 60 * 8,
};

itemList['francis_bush'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Francis Bush',
  price: 3000,
  weight: 11,
  nonStack: true,
  model: '',
  image: 'np_bush.png',
  information: 'im a wittle bushy boi',
};

itemList['1945849481'] = {
    fullyDegrades: false,
    decayrate: 0.25,
    displayname: 'The Light Saber',
    price: 1,
    craft: [[
      { itemid: 'refinedsteel', amount: 650 },
      { itemid: 'refinedaluminium', amount: 250 },
  ...
  itemList['watergun'] = {
    ...
    price: 1,
    craft: [[
      { itemid: 'refinedplastic', amount: 99999 },
    ]],
    weight: 7,
    nonStack: true,
    model: '',
    image: 'np_water_gun.png',
    information: 'Cool down on a hot summer day.',
    weapon: false,
    contraband: false,
  };