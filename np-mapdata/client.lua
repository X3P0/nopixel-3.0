		...
		-- Pillbox hospital:
			...
			-- Biker
				...
				local interiorsProps = {
					...
					DisableInteriorProp(247297, "weed_upgrade_equip")
					DisableInteriorProp(247297, "weed_drying")
					DisableInteriorProp(247297, "weed_security_upgrade")
	
					DisableInteriorProp(247297, "weed_production")
					DisableInteriorProp(247297, "weed_set_up")
					DisableInteriorProp(247297, "weed_chairs")
	
					DisableInteriorProp(247297, "weed_growtha_stage1")
					DisableInteriorProp(247297, "weed_growthb_stage1")
					DisableInteriorProp(247297, "weed_growthc_stage1")
	
					DisableInteriorProp(247297, "weed_growthd_stage1")
					DisableInteriorProp(247297, "weed_growthe_stage1")
					DisableInteriorProp(247297, "weed_growthf_stage1")
	
					DisableInteriorProp(247297, "weed_growthg_stage1")
					DisableInteriorProp(247297, "weed_growthh_stage1")
					DisableInteriorProp(247297, "weed_growthi_stage1")
	
					DisableInteriorProp(247297, "weed_hosea")
					DisableInteriorProp(247297, "weed_hoseb")
					DisableInteriorProp(247297, "weed_hosec")
	
					DisableInteriorProp(247297, "weed_hosed")
					DisableInteriorProp(247297, "weed_hosee")
					DisableInteriorProp(247297, "weed_hosef")
	
					DisableInteriorProp(247297, "weed_hoseg")
					DisableInteriorProp(247297, "weed_hoseh")
					DisableInteriorProp(247297, "weed_hosei")
