...
local disableBleeding = false

exports("DisableBleeding", function(pState)
	disableBleeding = pState
...
Currentstates = {
	...
	[28] = { ["text"] = "Bloodied Hands (Hunting).", ["status"] = false, ["timer"] = 0 },
	[29] = { ["text"] = "Traces of plastic and explosives residue", ["status"] = false, ["timer"] = 0 }, 
}
...
AddEventHandler("denoms", function(denomsp)
  ...
  hasdenoms = denomsp
  if hasdenoms then
    TriggerEvent('chatMessage', 'STATUS: ', 1, "Your currency has Multiple Denominations", "feed", false, { i18n = { "Your currency has Multiple Denominations" } })
  else
    TriggerEvent('chatMessage', 'STATUS: ', 1, "Your currency no longer has Multiple Denominations", "feed", false, { i18n = { "Your currency no longer has Multiple Denominations" } })
  end
end)
...
function HealEMS()
	Citizen.CreateThread(function()
	  ...
	  local healtime = time or 10
	  while healtime > 0 do
		  Citizen.Wait(1000)
		  healtime = healtime - 1
		  exports['ragdoll']:SetPlayerHealth(GetEntityHealth(PlayerPedId()) + 10, true)
	  end
...
function HealSlow(time, healamount)
  Citizen.CreateThread(function()
    if not healing then
      healing = true
    else
    ...
    while healtime > 0 do
        Citizen.Wait(1000)
        healtime = healtime - 1
        exports['ragdoll']:SetPlayerHealth(GetEntityHealth(PlayerPedId()) + (healamount and healamount or 1), true)
    end
...
function myBleeds()
    ...
    if not initialbleed and math.random(100) < 20 then
        if lightbleed or heavybleed or lightestbleed then
            ...
            exports['ragdoll']:SetPlayerHealth(GetEntityHealth(PlayerPedId()) - bleedmulti)
        end
    end
...
AddEventHandler("nns_weather:weatherHasChanged", function(pWeatherProgression)
...
AddEventHandler("Evidence:CurrentDamageListTarget",function(CurrentDamageListTarget,bt,targetid)
    for i = 1, #CurrentDamageListTarget do
      TriggerEvent('chatMessage', 'STATUS: ', 1, CurrentDamageListTarget[i], "feed", false, { i18n = getInjuryReplacements() })
    end
    local myJob = exports["isPed"]:isPed("myJob")
    if myJob == "police" or myJob == "ems" or myJob == "doctor" or myJob == "doc" then
...
AddEventHandler("Evidence:CurrentDamageList",function()
	...
	for i = 1, #CurrentDamageList do
		TriggerEvent('chatMessage', 'STATUS: ', 1, CurrentDamageList[i], "feed", false, { i18n = getInjuryReplacements() })
	end
	
	for i = 1, #bones do
		if bones[i]["timer"] > 0 then
			TriggerEvent('chatMessage', 'STATUS: ', 1, bones[i]["part"] .. " Injury", "feed", false, { i18n = getInjuryReplacements() })
		end
	...
	if imdead == 0 then
		...
		if InjuryType == 1 then
			...
			if math.random(50) > 45 then
				...
				exports['ragdoll']:SetPlayerHealth(curhealth)
...
local bedcoords = {
	...
	-- { ['x'] = 309.55,['y'] = -577.49,['z'] = 44.21,['h'] = 224.78},
	-- { ['x'] = 310.26,['y'] = -577.63,['z'] = 43.29,['h'] = 53.16 },   
	...
	{ ['x'] = -809.03,['y'] = -1221.09,['z'] = 8.26,['h'] = 223.85}, -- VespucciHospitalBed1
	{ ['x'] = -805.55,['y'] = -1224.1,['z'] = 8.26,['h'] = 237.63}, -- VespucciHospitalBed2
	{ ['x'] = -801.29,['y'] = -1227.72,['z'] = 8.26,['h'] = 221.34}, -- VespucciHospitalBed3
	{ ['x'] = -797.37,['y'] = -1230.99,['z'] = 8.26,['h'] = 227.98}, --  VespucciHospitalBed4
	{ ['x'] = -800.08,['y'] = -1234.65,['z'] = 8.26,['h'] = 40.09}, -- VespucciHospitalBed5
	{ ['x'] = -803.84,['y'] = -1231.24,['z'] = 8.26,['h'] = 46.73}, -- VespucciHospitalBed6
	{ ['x'] = -806.42,['y'] = -1229.09,['z'] = 8.26,['h'] = 42.52}, -- VespucciHospitalBed7
	{ ['x'] = -809.23,['y'] = -1226.82,['z'] = 8.26,['h'] = 50.09}, -- VespucciHospitalBed8
	{ ['x'] = -811.93,['y'] = -1224.65,['z'] = 8.26,['h'] = 44.64}, -- VespucciHospitalBed9

	-- Sandy Hospital Beds Coords
	{ ['x'] = 1827.084, ['y'] = 3677.80, ['z'] = 33.82, ['h'] = 23.95 }, --SandyHospitalBed1
	{ ['x'] = 1830.02, ['y'] = 3683.18, ['z'] = 33.82, ['h'] = 23.95 }, --SandyHospitalBed2
	{ ['x'] = 1828.05, ['y'] = 3683.18, ['z'] = 33.82, ['h'] = 194.66 }, --SandyHospitalBed3
	{ ['x'] = 1824.95, ['y'] = 3681.44, ['z'] = 33.82, ['h'] = 194.66 }, --SandyHospitalBed4
}
    ...
    if inbed then
      ...
      if not bonesUpdatingServer then
        TriggerEvent("bones:client:updateServer")
			...
			TriggerEvent("chatMessage", "Service ", 5, "It was a success!", "feed", false, { i18n = {"It was a success"} })
...
AddEventHandler("bed:checkin",function(skipServices)
	findBed(true, skipServices)
end)
